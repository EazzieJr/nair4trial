    ...
    <div>
      <div>
        <div class="Stats md:start">
          <div v-for="(stats) in transactionStats" :key="stats.title" class="Stat">
...
.Stats {
  ...
  .Stat {
    ...
    > span {
      @apply my-1.5 block text-3xl xl:text-4xl font-black text-[#1C3E77] xl:leading-[48px] tracking-[-0.03em]
    }
